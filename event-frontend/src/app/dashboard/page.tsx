export default function Dashboard(){
    return(
        <main className="flex font-rethink text-white bg-[#071029] w-full min-h-screen">
            <section className="h-100 w-full gap-5 flex justify-center items-center border border-white/10 rounded-lg overflow-hidden m-3 mt-19">
                <div>
